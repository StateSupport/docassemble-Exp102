...
setup(name='docassemble.Exp102',
      ...
      install_requires=['docassemble.ALToolbox>=0.9.0', 'docassemble.AssemblyLine>=2.26.0', 'docassemble.BrandingMN', 'docassemble.Exp102', 'docassemble.GithubFeedbackForm>=0.2.1'],
      zip_safe=False,
